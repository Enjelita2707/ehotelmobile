...
public class InputKamarActivity extends AppCompatActivity {
    ...
    private com.example.mobilehotelgroup2.Kamar kamar;
...
//        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        kamar = new com.example.mobilehotelgroup2.Kamar();
        initUI();
        //initEvent();
        Intent intent = getIntent();
        if (intent.hasExtra("kamar")) {
            kamar = (com.example.mobilehotelgroup2.Kamar) intent.getSerializableExtra("kamar");
    ...
    private void setData(com.example.mobilehotelgroup2.Kamar kamar) {
