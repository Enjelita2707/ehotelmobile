...
public class KamarAdapter extends RecyclerView.Adapter<KamarAdapter.KamarViewHolder>{
    List<com.example.mobilehotelgroup2.Kamar> kamar;
    Locale localeID = new Locale("in", "ID");
    NumberFormat formatRupiah = NumberFormat.getCurrencyInstance(localeID);

    public KamarAdapter(List<com.example.mobilehotelgroup2.Kamar> kamar) {
        this.kamar = kamar;
    }
    @Override
    ...
    public com.example.mobilehotelgroup2.Kamar getItem(int position) {
